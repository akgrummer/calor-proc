...
\author{\firstname{Solange} \lastname{Gu\'ehot}\inst{1,3}\fnsep\thanks{\email{Mail address for first
    author}} \and
...
\abstract{Insert your english abstract here. It should not normally exceed 200 words.
}
%
\maketitle
%
